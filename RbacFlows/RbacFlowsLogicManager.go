...
func getExpectedStatusCode(action string, apiName string) int {
	...
	case "manager":
		isValid = (apiName == UserRouter.GLOBALCONFIGURATIONS) ||
			...
			(apiName == UserRouter.ENVIRONMENTOVERRIDES) || (apiName == UserRouter.DELETE) || (apiName == UserRouter.PIPELINEDELETE) || (apiName == UserRouter.CREATEAPPMATERIAL) || (apiName == UserRouter.SAVECDPIPELINE)
	case "admin":
	...
	case "trigger":
		isValid = (apiName == UserRouter.APPLISTFETCH) || (apiName == UserRouter.PIPELINECREATE) || (apiName == UserRouter.PIPELINEFETCH) || (apiName == UserRouter.TRIGGERPIPELINE) || (apiName == UserRouter.APPDETAILS) || (apiName == UserRouter.CREATEAPPMATERIAL) || (apiName == UserRouter.SAVECDPIPELINE)
